...
///////////////////////////////////////////////////////////////////////////////
    //This methed is used to check if  user exists as a cutomer in the database.
	...
	Statement statement =
	    connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,
				       ResultSet.CONCUR_READ_ONLY);
	// Run the query, creating a ResultSet
	ResultSet r = statement.executeQuery("SELECT Email, Password FROM Customers WHERE Email='"+name+"' AND Password='"+password+"'");
	
		//count the results returned if 0 results returned, then the user does not exist.
...
///////////////////////////////////////////////////////////////////////////////
    //This method is used to query the database, and returns the result set produced.
    ...
    //this method is used to preform updates to the database and returns 
    //the number of rows effected.
    public int excuteQueryNoRe(String query)
        throws SQLException
    {
	// If we've called close(), then we can't call this method
	if (connection == null)
